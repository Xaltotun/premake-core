--
-- actions/vstudio/vs2016.lua
-- Extend the existing exporters with support for Visual Studio 2016.
-- Copyright (c) 2015-2015 Jason Perkins and the Premake project
--

	premake.vstudio.vs2016 = {}

	local p = premake
	local vstudio = p.vstudio
	local vc2010 = vstudio.vc2010

	local m = vstudio.vs2016


---
-- Define the Visual Studio 2016 export action.
---
	...
	newaction {
		...
		trigger     = "vs2016",
		shortname   = "Visual Studio 2016",
		description = "Generate Visual Studio 2016 project files",
